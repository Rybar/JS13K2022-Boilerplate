...
var RetroBuffer = function(width, height, atlas, pages){
  ...
  RetroBuffer.prototype.setPen = function setPen(color, color2, dither=0){
    this.cursorColor = color;
    this.cursorColor2 = color2;
    this.pat=dither;
  }

  RetroBuffer.prototype.clr = function clr(color, page){
 ...
 RetroBuffer.prototype.strokePolygon = function strokePolygon(x,y,r,sides, rotation=0, color='white'){
